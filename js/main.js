...
const translations = {
  tr: {
    ...
    contact_desc: "Bir projen mi var? Hadi konuşalım.",
    ...
    proj_desc: "Projelerim",
    badge_os: "Açık Kaynak",
    btn_demo: "Live Demo",
    btn_review: "İncele",
    ...
    proj_4_desc: "HaxEm Studio web sitesi.",
    proj_5_desc: "Minecraft sunucuları için geliştirilmiş olan zaman bazlı nether sistemi.",
    proj_6_desc: "Minecraft sunucuları için geliştirilmiş olan ilerlemeye göre otomatik rütbe sistemi + ödül veren bir sistem.",
    proj_7_desc: "Minecraft sunucuları için ücretsiz olarak web üzerinden yüksek kaliteli rank görselleri oluşturma sitesi.",
  ...
  en: {
    ...
    contact_desc: "Do you have a project? Let's talk.",
    ...
    proj_desc: "My Projects",
    badge_os: "Open Source",
    btn_demo: "Live Demo",
    btn_review: "Review",
    ...
    proj_4_desc: "HaxEm Studio website.",
    proj_5_desc: "Time-based nether system developed for Minecraft servers.",
    proj_6_desc: "Automatic rank system based on progress + reward giving system developed for Minecraft servers.",
    proj_7_desc: "A free website to generate high-quality rank images for Minecraft servers.",
